...
function Button({
  ...
  return (
    <Pressable
      ...
      {isChecked && (
        <CustomIcon name="AimFillSvg" size={20} color={colors[theme].PRIMARY} />
      )}
    </Pressable>
  );
}
...
function CheckBox({
  ...
  return (
    <Pressable
      ...
      {...props}>
      <CustomIcon
        name={isChecked ? 'AddFillSvg' : 'AddLineSvg'}
        size={22}
  ...
  return (
    <Pressable style={styles.filterContainer} {...props}>
      ...
      <CustomIcon
        name="DownsmFillSvg"
        size={22}
        color={isSelected ? colors[theme].SECONDARY : colors[theme].GRAY_300}
      />
    </Pressable>
  );
}
